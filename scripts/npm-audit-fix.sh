git clone https://github.com/AgoricBot/eventual-send.git
cd eventual-send
git remote add upstream https://github.com/Agoric/eventual-send.git
git remote set-url origin https://AgoricBot:$GITHUB_TOKEN@github.com/AgoricBot/eventual-send.git
git fetch upstream
git checkout master
...
if [ "$files_changed" = true ] ; then
  ...
  hub pull-request --no-edit --base Agoric/eventual-send:master
fi

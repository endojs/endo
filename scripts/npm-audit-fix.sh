git clone https://github.com/AgoricBot/marshal.git
cd marshal
git remote add upstream https://github.com/Agoric/marshal.git
git remote set-url origin https://AgoricBot:$GITHUB_TOKEN@github.com/AgoricBot/marshal.git
git fetch upstream
git checkout master
...
if [ "$files_changed" = true ] ; then
  ...
  hub pull-request --no-edit --base Agoric/marshal:master
fi

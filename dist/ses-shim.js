var SES = (function (exports) {
  ...
  function getAnonIntrinsics$1(global) {
    ...
    function* aStrictGenerator() {}  const Generator = getProto(aStrictGenerator);
    async function* aStrictAsyncGenerator() {}  const AsyncGenerator = getProto(aStrictAsyncGenerator);
    async function aStrictAsyncFunction() {}  const AsyncFunctionPrototype = getProto(aStrictAsyncFunction);
  ...
  function hardenPrimoridals(global) {
    const root = {
  ...
  function createSESWithRealmConstructor(creatorStrings, Realm) {
    function makeSESRootRealm(options) {
      ...
      const getAnonIntrinsics = (${getAnonIntrinsics$1});
      (${hardenPrimoridals})`;

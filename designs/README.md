...
*Layered on 2026-07-15: revised [conservative-regexp-subset](conservative-regexp-subset.md) to the RFC 9485 / Endo issue #3079 direction: full parse and safe-profile validation, JavaScript ponyfill delegation, fixed JS-Rust corpus, and an Endor import-graph condition.*

...
- [#3305](https://github.com/endojs/endo/pull/3305) [`6d6160d`](https://github.com/endojs/endo/commit/6d6160d6a0e18d89a8638f0f43a48b9712cf3877) Thanks [@turadg](https://github.com/turadg)! - Republish with resolved dependency versions. The 2.6.0 manifest on npm shipped `catalog:` protocol specifiers for `eslint-plugin-import` and `typescript`, which npm cannot resolve; the publish toolchain now resolves the `catalog:` protocol to concrete version ranges at pack time. Fixes <https://github.com/endojs/endo/issues/3304>.

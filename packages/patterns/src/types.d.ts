 ...
 */
export type Key = string | number | bigint | boolean | symbol | RemotableObject | import("@endo/pass-style").CopyArrayI<RemotableObject, never> | import("@endo/pass-style").CopyRecordI<RemotableObject, never> | import("@endo/pass-style").CopyTaggedI<RemotableObject, never> | null | undefined;
 ...
 * of Patterns.
 */
export type Pattern = string | number | bigint | boolean | symbol | RemotableObject<string> | import("@endo/pass-style").CopyArrayI<import("@endo/pass-style").PassableCap, Error> | import("@endo/pass-style").CopyRecordI<import("@endo/pass-style").PassableCap, Error> | import("@endo/pass-style").CopyTaggedI<import("@endo/pass-style").PassableCap, Error> | null | undefined;
/**
 ...
 */
export type CopySet<K extends Key = Key> = import("@endo/pass-style").PassStyled<"tagged", "copySet"> & {
    payload: K[];
};
/**
 ...
 */
export type CopyBag<K extends Key = Key> = import("@endo/pass-style").PassStyled<"tagged", "copyBag"> & {
    payload: [K, bigint][];
};
/**
 * A Passable collection of entries with Keys that are all mutually distinguishable
 ...
 */
export type CopyMap<K extends Key = Key, V extends Passable = Passable> = import("@endo/pass-style").PassStyled<"tagged", "copyMap"> & {
    payload: {
        keys: K[];
        values: V[];
    };
 ...
 */
export type Matcher = import("@endo/pass-style").PassStyled<"tagged", `match:${string}`> & {
    payload: Passable;
};
/**
 ...
 */
export type FullCompare = (left: any, right: any) => import("@endo/marshal").RankComparison;
...
export type PatternMatchers = {
     ...
     */
    splitRecord: (required: CopyRecord<Pattern>, optional?: CopyRecord<Pattern> | undefined, rest?: Pattern) => Matcher;
    /**
     ...
     */
    split: (basePatt: CopyArray<any> | CopyRecord<any>, rest?: Pattern) => Matcher;
    /**
     * Deprecated. Use `M.splitArray` or `M.splitRecord` instead.
     * An array or record is split into the first part that is matched by
     * `basePatt`, and the remainder, which is matched against `rest` if present.
     ...
     */
    partial: (basePatt: CopyArray<any> | CopyRecord<any>, rest?: Pattern) => Matcher;
    /**
...
export type InterfaceGuard<T extends Record<PropertyKey, MethodGuard> = Record<PropertyKey, MethodGuard>> = import("@endo/pass-style").PassStyled<"tagged", "guard:interfaceGuard"> & {
    payload: InterfaceGuardPayload<T>;
};
/**
...
export type MethodGuard = import("@endo/pass-style").PassStyled<"tagged", "guard:methodGuard"> & {
    payload: MethodGuardPayload;
};
export type AwaitArgGuardPayload = {
    argGuard: Pattern;
};
export type AwaitArgGuard = import("@endo/pass-style").PassStyled<"tagged", "guard:awaitArgGuard"> & {
    payload: AwaitArgGuardPayload;
};
export type RawGuardPayload = {};
export type RawGuard = import("@endo/pass-style").PassStyled<"tagged", "guard:rawGuard"> & {
    payload: RawGuardPayload;
};

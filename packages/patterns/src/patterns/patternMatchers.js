 ...
 *
 * @param {import('./internal-types.js').Limits} [limits]
 * @returns {import('./internal-types.js').AllLimits}
 */
const limit = (limits = {}) =>
  /** @type {import('./internal-types.js').AllLimits} */ (
 ...
 * @param {import('./internal-types.js').Checker} check
 */
...
/**
 * @returns {import('./internal-types.js').PatternKit}
 */
const makePatternKit = () => {
   ...
   *
   * @param {string} tag
   * @returns {import('./internal-types.js').MatchHelper | undefined}
   */
   ...
   *
   * @param {string} tag
   * @returns {import('./internal-types.js').Pattern | undefined}
   */
  const maybePayloadShape = tag =>
    // eslint-disable-next-line no-use-before-define
    GuardPayloadShapes[tag];

  /** @type {Map<import('./internal-types.js').Kind, unknown>} */
  ...
  /**
   * @type {WeakMap<import('./internal-types.js').CopyTagged, import('./internal-types.js').Kind>}
   ...
   *
   * @param {import('./internal-types.js').Passable} tagged
   * @param {import('./internal-types.js').Kind} tag
   * @param {import('./internal-types.js').Checker} check
   * @returns {boolean}
   */
   ...
   *
   * @param {import('./internal-types.js').Passable} specimen
   * @param {import('./internal-types.js').Checker} [check]
   * @returns {import('./internal-types.js').Kind | undefined}
   */
   ...
   *
   * @param {import('./internal-types.js').Passable} specimen
   * @param {import('./internal-types.js').Kind} kind
   * @param {import('./internal-types.js').Checker} check
   * @returns {boolean}
   */
  ...
  /**
   * @param {import('./internal-types.js').Passable} specimen
   * @param {import('./internal-types.js').Key} keyAsPattern
   * @param {import('./internal-types.js').Checker} check
   * @returns {boolean}
   */
  ...
  /** @type {import('./internal-types.js').CheckPattern} */
  ...
  /**
   * @param {import('./internal-types.js').Passable} patt
   * @returns {boolean}
   */
  const isPattern = patt => checkPattern(patt, identChecker);

  /**
   * @param {import('./internal-types.js').Pattern} patt
   */
  ...
  /**
   * @param {import('./internal-types.js').Passable} specimen
   * @param {import('./internal-types.js').Pattern} pattern
   * @param {import('./internal-types.js').Checker} check
  ...
  /** @type {import('./internal-types.js').GetRankCover} */
  ...
  /**
   * @param {import('./internal-types.js').Passable[]} array
   * @param {import('./internal-types.js').Pattern} patt
   * @param {import('./internal-types.js').Checker} check
  ...
  /** @type {import('./internal-types.js').MatchHelper} */
  ...
  /**
   * @param {import('./internal-types.js').Passable[]} specimen
   * @param {import('./internal-types.js').Pattern[]} requiredPatt
   * @param {import('./internal-types.js').Pattern[]} optionalPatt
   * @returns {{
   *   requiredSpecimen: import('./internal-types.js').Passable[],
   *   optionalSpecimen: import('./internal-types.js').Passable[],
   *   restSpecimen: import('./internal-types.js').Passable[]
   * }}
   */
   ...
   * @param {import('./internal-types.js').Pattern[]} optionalPatt
   * @param {number} length
   * @returns {import('./internal-types.js').Pattern[]} The partialPatt
   */
  ...
  /**
   * @param {import('./internal-types.js').CopyRecord<import('./internal-types.js').Passable>} specimen
   * @param {import('./internal-types.js').CopyRecord<import('./internal-types.js').Pattern>} requiredPatt
   * @param {import('./internal-types.js').CopyRecord<import('./internal-types.js').Pattern>} optionalPatt
   * @returns {{
   *   requiredSpecimen: import('./internal-types.js').CopyRecord<import('./internal-types.js').Passable>,
   *   optionalSpecimen: import('./internal-types.js').CopyRecord<import('./internal-types.js').Passable>,
   *   restSpecimen: import('./internal-types.js').CopyRecord<import('./internal-types.js').Passable>
   * }}
   */
  const splitRecordParts = (specimen, requiredPatt, optionalPatt) => {
    // Not frozen! Mutated in place
    /** @type {[string, import('./internal-types.js').Passable][]} */
   ...
   * @param {import('./internal-types.js').CopyRecord<import('./internal-types.js').Pattern>} optionalPatt
   * @param {string[]} names
   * @returns {import('./internal-types.js').CopyRecord<import('./internal-types.js').Pattern>} The partialPatt
   */
  ...
  /** @type {Record<string, import('./internal-types.js').MatchHelper>} */
   ...
   *
   * @param {string} tag
   * @param {import('./internal-types.js').Passable[]} payload
   */
  ...
  /** @type {import('./internal-types.js').MatcherNamespace} */
  const M = harden({
    any: () => AnyShape,
...
/**
 * @param {any} specimen
 * @returns {specimen is import('./internal-types.js').AwaitArgGuard}
 */
...
/**
 * @param {any} specimen
 * @returns {asserts specimen is import('./internal-types.js').AwaitArgGuard}
 */
 ...
 *
 * @param {import('./internal-types.js').AwaitArgGuard} awaitArgGuard
 * @returns {import('./internal-types.js').AwaitArgGuardPayload}
 */
...
/**
 * @param {import('./internal-types.js').Pattern} argPattern
 * @returns {import('./internal-types.js').AwaitArgGuard}
 */
const makeAwaitArgGuard = argPattern => {
  /** @type {import('./internal-types.js').AwaitArgGuard} */
...
/**
 * @returns {import('./internal-types.js').RawGuard}
 */
...
/**
 * @param {any} specimen
 * @returns {asserts specimen is import('./internal-types.js').MethodGuard}
 */
 ...
 * we smooth the transition to https://github.com/endojs/endo/pull/1712
 *
 * @param {import('./internal-types.js').MethodGuard} methodGuard
 * @returns {import('./internal-types.js').MethodGuardPayload}
 */
 ...
 * @param {import('./internal-types.js').ArgGuard[]} argGuards
 * @param {import('./internal-types.js').ArgGuard[]} [optionalArgGuards]
 * @param {import('./internal-types.js').SyncValueGuard} [restArgGuard]
 * @returns {import('./internal-types.js').MethodGuardMaker}
 */
const makeMethodGuardMaker = (
  ...
  harden({
    ...
    returns: (returnGuard = M.undefined()) => {
      /** @type {import('./internal-types.js').MethodGuard} */
...
/**
 * @param {any} specimen
 * @returns {asserts specimen is import('./internal-types.js').InterfaceGuard}
 */
 ...
 * we smooth the transition to https://github.com/endojs/endo/pull/1712
 *
 * @template {Record<PropertyKey, import('./internal-types.js').MethodGuard>} [T=Record<PropertyKey, import('./internal-types.js').MethodGuard>]
 * @param {import('./internal-types.js').InterfaceGuard<T>} interfaceGuard
 * @returns {import('./internal-types.js').InterfaceGuardPayload<T>}
 */
...
/**
 * @param {import('./internal-types.js').InterfaceGuard} interfaceGuard
...
/**
 * @template {Record<PropertyKey, import('./internal-types.js').MethodGuard>} [M = Record<PropertyKey, import('./internal-types.js').MethodGuard>]
 * @param {string} interfaceName
 * @param {M} methodGuards
 * @param {{ sloppy?: boolean, defaultGuards?: import('../types.js').DefaultGuardType }} [options]
 * @returns {import('./internal-types.js').InterfaceGuard<M>}
 */
const makeInterfaceGuard = (interfaceName, methodGuards, options = {}) => {
  ...
  /** @type {Record<string, import('./internal-types.js').MethodGuard>} */
  const stringMethodGuards = {};
  /** @type {Array<[symbol, import('./internal-types.js').MethodGuard]>} */
  ...
  return /** @type {import('./internal-types.js').InterfaceGuard<M>} */ (
    result
  );
};

...
const exportsReturn = require('exports-shenanigans/exports-return');
...
module.exports.assertions = {
  ...
  packageExportsShenanigans() {
    ...
    if (exportsReturn.magicNumber !== 42) {
      throw Error('returning from the top level of the cjs module should set module.exports');
    }
    if (defineExports !== 11) {
      throw Error('Overwriting module.exports with defineProprty should be possible.');
    }
  },
};

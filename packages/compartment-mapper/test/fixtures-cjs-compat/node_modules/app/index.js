...
module.exports.assertions = {
  packageWithDefineProperty() {
    if (!defineprop.isOk) {
      throw Error(
        'Expected exports created by defineProperty to be available',
      );
    }
  },
  moduleWithCycle() {
  ...
  parserStruggles() {
    if (!parserStruggles.isOk) {
      throw Error('Failed to get exports from nested require and no errors ocurred in the process.');
    }
  },
  ...
  packageReferencingItself() {
    try {
      ...
      throw Error('Referencing exported functions should be possible', {
        cause: e,
      });
    }
  },

 ...
 * @param {string} location - Full URL of the module (e.g. `file:///pkg/lib/index.js`)
 * @param {ReadFn | ReadPowers | undefined} readPowers
 * @param {string} [packageLocation] - URL of the package root (e.g. `file:///pkg/`). Used to resolve relative dynamic specifiers against the referrer module.
 * @returns {FinalStaticModuleType}
 */

export const buildCjsExecuteRecord = (
  cjsRecord,
  location,
  readPowers,
  packageLocation,

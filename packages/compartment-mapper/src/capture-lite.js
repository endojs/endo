...
const makeLoadCompartments = (
  ...
  /**
   * Finds {@link CompartmentDescriptor CompartmentDescriptors} having the
   * {@link CompartmentDescriptor.load load} bit set, then loads the entry point
   * of each via its associated {@link Compartment}.
   *

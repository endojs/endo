...
/**
 * @param {import('./types.js').LoadCompartmentMapForArchiveOptions & ArchiveOptions} options
 * @returns {Promise<import('./types.js').LoadCompartmentMapForArchiveResult>}
 */
export const loadCompartmentMapForArchive = async ({
  readPowers,
  moduleLocation,
  moduleTransforms,
  modules: exitModules = {},

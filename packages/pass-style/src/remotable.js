 ...
 * @param {InterfaceSpec} iface
 */
export const assertIface = iface => confirmIface(iface, Reject);
harden(assertIface);
...
const confirmRemotableProtoOf = (original, reject) => {
  ...
  if (typeof original === 'object') {
    ...
    if (protoProto !== objectPrototype && protoProto !== null) {
      ...
      return checkRemotable(proto, reject);
    }
 ...
 */
const checkRemotable = (val, reject) => {
...
export const RemotableHelper = harden({
  ...
  assertRestValid: candidate => checkRemotable(candidate, Reject),

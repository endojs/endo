 ...
 */
export type RemotableObject = Passable;
/**
 ...
 */
export type CopyArray<T extends unknown = any> = T[];
/**
 * A Passable dictionary in which each key is a string and each value is Passable.
 */
export type CopyRecord<T extends unknown = any> = Record<string, T>;
/**
 ...
 */
export type CopyTagged<Tag extends string = string, Payload extends unknown = any> = {
 ...
 */
export type Checker = (cond: boolean, details?: import("ses").Details | undefined) => boolean;

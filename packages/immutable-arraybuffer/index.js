export * from './src/limited-pony-for-hermes.js';

// The uncommented code below is from the real `index.js` which has the extra
// functionality, transferToImmutable`, not possible on Hermes.

...
at `src/netlayers/tor.js`, exposed via the `@endo/ocapn/netlayer/tor` subpath
and designed to be compatible with Spritely Goblins' Guile onion netlayer
conventions.

```js
import { makeTorNetLayer } from '@endo/ocapn/netlayer/tor';

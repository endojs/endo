...
export type EncodingUnion = import('./types.js').EncodingUnion;
export type EncodeToCapDataOptions = {
    encodeRemotableToCapData?: ((remotable: Remotable, encodeRecur: (p: Passable) => Encoding) => Encoding) | undefined;
...
export type DecodeOptions = {
    decodeRemotableFromCapData?: ((encodedRemotable: Encoding, decodeRecur: (e: Encoding) => Passable) => (Promise<any> | Remotable)) | undefined;
    decodePromiseFromCapData?: ((encodedPromise: Encoding, decodeRecur: (e: Encoding) => Passable) => (Promise<any> | Remotable)) | undefined;

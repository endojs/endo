...
test('weak bimap: add and getValue', t => {
...
test('weak bimap: getAllValues', t => {
  const bimap = makeBidirectionalMultimap();
  const key = 'foo';
  const value1 = {};
  const value2 = {};
...
test('weak bimap: add and getKey', t => {
  const bimap = makeBidirectionalMultimap();
  const key = 'foo';
  const value = {};
...
test('weak bimap: add and getKey with multiple values', t => {
  const bimap = makeBidirectionalMultimap();
  const key1 = 'foo';
  const value1 = {};
  const value2 = {};
...
test('weak bimap: key remapping', t => {
  const bimap = makeBidirectionalMultimap();
  const key1 = 'foo';
  const key2 = 'bar';
  const value1 = {};

...
export function makeDaemonicPersistencePowers(filePowers: import('./types.js').FilePowers, cryptoPowers: import('./types.js').CryptoPowers, locator: import('./types.js').Locator, includeWebPageBundler?: boolean | undefined): import('./types.js').DaemonicPersistencePowers;

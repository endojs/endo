...
declare const bareOrQuote: (payload: any, spaces?: string | number | undefined) => import("ses").StringablePayload;
...
export const quote: (payload: any, spaces?: string | number | undefined) => import("ses").StringablePayload;

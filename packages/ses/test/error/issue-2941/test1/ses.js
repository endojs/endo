...
(functors => options => {
  ...
  defineProperties(cells[11], {
    makeCacheMapKit: { value: cells[10]['makeCacheMapKit'] },
  });
  ...
  functors[0]({
    ...
    onceVar: {
      ...
      AsyncGeneratorFunctionInstance:
        cells[0].AsyncGeneratorFunctionInstance.set,
    },
    importMeta: {},
  });
  functors[1]({
  ...
  functors[28]({
    ...
    onceVar: {
      setGlobalObjectSymbolUnscopables:
        cells[28].setGlobalObjectSymbolUnscopables.set,
      setGlobalObjectConstantProperties:
        cells[28].setGlobalObjectConstantProperties.set,
      setGlobalObjectMutableProperties:
        cells[28].setGlobalObjectMutableProperties.set,
  ...
  functors[30]({
    ...
    onceVar: {
      createSloppyGlobalsScopeTerminator:
        cells[30].createSloppyGlobalsScopeTerminator.set,
    },
    importMeta: {},
  });
  functors[31]({
  ...
  functors[33]({
    ...
    onceVar: {
      ...
      rejectSomeDirectEvalExpressions:
        cells[33].rejectSomeDirectEvalExpressions.set,
  ...
  functors[40]({
    ...
    onceVar: {
      ...
      defineCausalConsoleFromLogger:
        cells[40].defineCausalConsoleFromLogger.set,
  ...
  ({
    ...
    (function () {
      ...
      /** @type {<T, U>(thisArg: readonly T[], callbackfn: (value: T, index: number, array: T[]) => U, cbThisArg?: any) => U[]} */ $h͏_once.arrayJoin(
        arrayJoin,
      );
      ...
      /** @type {<T>(thisArg: T[], ...items: T[]) => number} */ $h͏_once.arrayPop(
        arrayPop,
      );
      ...
      /** @type {(b: ArrayBuffer) => number} */ $h͏_once.arrayBufferSlice(
        arrayBufferSlice,
      );
      ...
      /** @type {<K extends {}, V>(thisArg: WeakMap<K, V>, ...args: Parameters<WeakMap<K,V>['get']>) => ReturnType<WeakMap<K,V>['get']>} */ $h͏_once.weakmapDelete(
        weakmapDelete,
      );
      ...
      /** @type {<T, TResult1 = T, TResult2 = never>(thisArg: T, onfulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined | null, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | undefined | null) => Promise<TResult1 | TResult2>} */ $h͏_once.promiseCatch(
        promiseCatch,
      );
       ...
       *
       * @param {Function} fn
       */ $h͏_once.finalizationRegistryUnregister(
        finalizationRegistryUnregister,
      );
  ...
  ({
    ...
    (function () {
      ...
      let TypeError;
      $h͏_imports([
        ['./commons.js', [['TypeError', [$h͏_a => (TypeError = $h͏_a)]]]],
      ]);
    ...
    (function () {
      ...
      const makeEnvironmentCaptor = (aGlobal, dropNames = false) => {
        ...
        const getEnvironmentOption = (
          ...
          const globalEnv =
            (typeof globalProcess === 'object' && globalProcess.env) ||
            undefined;
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        [
          './immutable-arraybuffer-pony.js',
          [
            ['isBufferImmutable', [$h͏_a => (isBufferImmutable = $h͏_a)]],
            [
              'sliceBufferToImmutable',
              [$h͏_a => (sliceBufferToImmutable = $h͏_a)],
            ],
            [
              'optTransferBufferToImmutable',
              [$h͏_a => (optXferBuf2Immu = $h͏_a)],
            ],
          ],
        ],
      ]);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        [
          '@endo/cache-map',
          [['makeCacheMapKit', [$h͏_a => (makeCacheMapKit = $h͏_a)]]],
        ],
      ]);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            [
              'makeNoteLogArgsArrayKit',
              [$h͏_a => (makeNoteLogArgsArrayKit = $h͏_a)],
            ],
          ],
        ],
      ]);
      ...
      const redactedDetails = (template, ...args) => {
        ...
        return /** @type {DetailsToken} */ (
          /** @type {unknown} */ (detailsToken)
        );
      };
      ...
      $h͏_imports([
        [
          ...
          [
            ...
            [
              'getOwnPropertyDescriptor',
              [$h͏_a => (getOwnPropertyDescriptor = $h͏_a)],
            ],
            [
              'getOwnPropertyDescriptors',
              [$h͏_a => (getOwnPropertyDescriptors = $h͏_a)],
            ...
            ['isPrimitive', [$h͏_a => (isPrimitive = $h͏_a)]],
            ['hasOwn', [$h͏_a => (hasOwn = $h͏_a)]],
            ['ownKeys', [$h͏_a => (ownKeys = $h͏_a)]],
  ...
  ({
    ...
    (function () {
      ...
      /** @type {GenericErrorConstructor[]} */ $h͏_once.uniqueGlobalPropertyNames(
        uniqueGlobalPropertyNames,
      );
      const NativeErrors = [
        EvalError,
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        [
          './cauterize-property.js',
          [['cauterizeProperty', [$h͏_a => (cauterizeProperty = $h͏_a)]]],
        ],
        [
          './commons.js',
          [
        ...
        [
          ...
          [
            ...
            [
              'sharedGlobalPropertyNames',
              [$h͏_a => (sharedGlobalPropertyNames = $h͏_a)],
            ],
            [
              'universalPropertyNames',
              [$h͏_a => (universalPropertyNames = $h͏_a)],
            ],
    ...
    (function () {
      ...
      function removeUnpermittedIntrinsics(
        ...
        function visitPrototype(path, obj, protoName) {
          if (isPrimitive(obj)) {
            throw TypeError(
              `Object expected: ${path}, ${String(obj)}, ${protoName}`,
            );
          }
          const proto = getPrototypeOf(obj);
      ...
      $h͏_imports([
        [
          ...
          [
            ...
            [
              'AsyncGeneratorFunctionInstance',
              [$h͏_a => (AsyncGeneratorFunctionInstance = $h͏_a)],
            ],
          ],
        ],
      ]);
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          ...
          [['makeEvalFunction', [$h͏_a => (makeEvalFunction = $h͏_a)]]],
        ],
        [
          ...
          [
            [
              'makeFunctionConstructor',
              [$h͏_a => (makeFunctionConstructor = $h͏_a)],
            ],
          ],
        ],
        [
       ...
       *
       * @param {object} globalObject
       */ $h͏_once.setGlobalObjectSymbolUnscopables(
        setGlobalObjectSymbolUnscopables,
      );
       ...
       */ $h͏_once.setGlobalObjectConstantProperties(
        setGlobalObjectConstantProperties,
      );
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            [
              'strictScopeTerminatorHandler',
              [$h͏_a => (strictScopeTerminatorHandler = $h͏_a)],
            ],
      ...
      $h͏_once.createSloppyGlobalsScopeTerminator(
        createSloppyGlobalsScopeTerminator,
      );
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './get-source-url.js',
          [['getSourceURL', [$h͏_a => (getSourceURL = $h͏_a)]]],
        ],
      ]);
       ...
       * @param {string} source
       * @returns {string}
       */ $h͏_once.rejectSomeDirectEvalExpressions(
        rejectSomeDirectEvalExpressions,
      );
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './scope-constants.js',
          [['getScopeConstants', [$h͏_a => (getScopeConstants = $h͏_a)]]],
        ],
      ]);
      ...
      const makeEvaluate = context => {
        const { globalObjectConstants, moduleLexicalConstants } =
          getScopeConstants(context.globalObject, context.moduleLexicals);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './eval-scope.js',
          [['makeEvalScopeKit', [$h͏_a => (makeEvalScopeKit = $h͏_a)]]],
        ],
        [
          './transforms.js',
          [
        ...
        [
          './make-evaluate.js',
          [['makeEvaluate', [$h͏_a => (makeEvaluate = $h͏_a)]]],
        ],
        ['./error/assert.js', [['assert', [$h͏_a => (assert = $h͏_a)]]]],
      ]);
      ...
      const tameModuleSource = () => {
        ...
        if (ModuleSource !== undefined) {
          ...
          if (ModuleSourcePrototype !== undefined) {
            ...
            // AbstractModuleSource.prototype.
            const ModuleSourcePrototypeProto = getPrototypeOf(
              ModuleSourcePrototype,
            );
  ...
  ({
    ...
    (function () {
      ...
      /** @type {readonly [ConsoleProps, LogSeverity | undefined][]} */ $h͏_once.consoleOtherMethods(
        consoleOtherMethods,
      );
      ...
      const makeLoggingConsoleKit = (
        ...
        const typedLoggingConsole = /** @type {VirtualConsole} */ (
          loggingConsole
        );
      ...
      $h͏_imports([
        [
          ...
          [
            ...
            [
              'finalizationRegistryRegister',
              [$h͏_a => (finalizationRegistryRegister = $h͏_a)],
            ],
            ['weakmapSet', [$h͏_a => (weakmapSet = $h͏_a)]],
            ['weakmapGet', [$h͏_a => (weakmapGet = $h͏_a)]],
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './assert.js',
          [['loggedErrorHandler', [$h͏_a => (defaultHandler = $h͏_a)]]],
        ],
        [
          './console.js',
          [['makeCausalConsole', [$h͏_a => (makeCausalConsole = $h͏_a)]]],
        ],
        [
  ...
  ({
    ...
    (function () {
      ...
      const CALLSITE_ELLIPSIS_PATTERN1 =
        /^((?:.*[( ])?)[:/\w_-]*\/\.\.\.\/(.+)$/;
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            [
              'tameV8ErrorConstructor',
              [$h͏_a => (tameV8ErrorConstructor = $h͏_a)],
            ],
          ],
        ],
      ]);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        [
          '@endo/env-options',
          [['getEnvironmentOption', [$h͏_a => (getenv = $h͏_a)]]],
        ],
        [
          './commons.js',
          [
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            ...
            [
              'evadeImportExpressionTest',
              [$h͏_a => (evadeImportExpressionTest = $h͏_a)],
            ],
            [
              'rejectSomeDirectEvalExpressions',
              [$h͏_a => (rejectSomeDirectEvalExpressions = $h͏_a)],
            ],
          ],
        ],
        [
          './make-safe-evaluator.js',
          [['makeSafeEvaluator', [$h͏_a => (makeSafeEvaluator = $h͏_a)]]],
        ],
      ]);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './module-proxy.js',
          [['getDeferredExports', [$h͏_a => (getDeferredExports = $h͏_a)]]],
        ],
        [
          './commons.js',
          [
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            ...
            [
              'makeVirtualModuleInstance',
              [$h͏_a => (makeVirtualModuleInstance = $h͏_a)],
            ],
          ],
        ],
        [
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            ...
            [
              'setGlobalObjectEvaluators',
              [$h͏_a => (setGlobalObjectEvaluators = $h͏_a)],
            ],
          ],
        ],
        [
      ...
      /** @type {MakeCompartmentConstructor} */ $h͏_once.compartmentOptions(
        compartmentOptions,
      );
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './compartment.js',
          [['InertCompartment', [$h͏_a => (InertCompartment = $h͏_a)]]],
        ],
      ]);
      ...
      $h͏_imports([
        [
          ...
          [
            ...
            [
              'arrayBufferGetByteLength',
              [$h͏_a => (arrayBufferGetByteLength = $h͏_a)],
            ],
        ...
        const methods = {
          ...
          transfer(newLength = undefined) {
            ...
            if (typeof newLength !== 'number') {
              throw TypeError(
                `transfer newLength if provided must be a number`,
              );
            }
            if (newLength > oldLength) {
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './make-hardener.js',
          [['makeHardener', [$h͏_a => (makeHardener = $h͏_a)]]],
        ],
        [
          './intrinsics.js',
          [
            [
              'makeIntrinsicsCollector',
              [$h͏_a => (makeIntrinsicsCollector = $h͏_a)],
            ],
          ],
        ],
        [
          './permits-intrinsics.js',
          [['default', [$h͏_a => (removeUnpermittedIntrinsics = $h͏_a)]]],
        ],
        [
        ...
        [
          ...
          [['default', [$h͏_a => (tameDateConstructor = $h͏_a)]]],
        ],
        [
          './tame-math-object.js',
          [['default', [$h͏_a => (tameMathObject = $h͏_a)]]],
        ],
        [
          './tame-regexp-constructor.js',
          [['default', [$h͏_a => (tameRegExpConstructor = $h͏_a)]]],
        ],
        [
        ...
        [
          ...
          [['default', [$h͏_a => (tameLocaleMethods = $h͏_a)]]],
        ],
        [
          './global-object.js',
          [
        ...
        [
          ...
          [
            [
              'initialGlobalPropertyNames',
              [$h͏_a => (initialGlobalPropertyNames = $h͏_a)],
            ],
          ],
        ],
        [
        ...
        [
          './tame-domains.js',
          [['tameDomains', [$h͏_a => (tameDomains = $h͏_a)]]],
        ],
        [
          './tame-module-source.js',
          [['tameModuleSource', [$h͏_a => (tameModuleSource = $h͏_a)]]],
        ],
        [
          './error/tame-console.js',
          [['tameConsole', [$h͏_a => (tameConsole = $h͏_a)]]],
        ],
        [
        ...
        [
          ...
          [
            [
              'getAnonymousIntrinsics',
              [$h͏_a => (getAnonymousIntrinsics = $h͏_a)],
            ],
          ],
        ],
        [
          ...
          [
            [
              'makeCompartmentConstructor',
              [$h͏_a => (makeCompartmentConstructor = $h͏_a)],
            ],
          ],
        ],
        ...
        [
          ...
          [
            [
              'tameFauxDataProperties',
              [$h͏_a => (tameFauxDataProperties = $h͏_a)],
            ],
          ],
        ],
        [
          ...
          [
            [
              'tameRegeneratorRuntime',
              [$h͏_a => (tameRegeneratorRuntime = $h͏_a)],
            ],
          ],
        ],
        [
          ...
          [
            [
              'shimArrayBufferTransfer',
              [$h͏_a => (shimArrayBufferTransfer = $h͏_a)],
            ],
          ],
        ],
        [
      ...
      const repairIntrinsics = (options = {}) => {
        ...
        if (
          typeof (/** @type {any} */ (consoleRecord.console)._times) ===
          'object'
        ) {
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './lockdown.js',
          [['repairIntrinsics', [$h͏_a => (repairIntrinsics = $h͏_a)]]],
        ],
      ]);
  ...
  ({
    ...
    (function () {
      ...
      $h͏_imports([
        ...
        [
          './intrinsics.js',
          [['getGlobalIntrinsics', [$h͏_a => (getGlobalIntrinsics = $h͏_a)]]],
        ],
        [
          './reporting.js',
          [['chooseReporter', [$h͏_a => (chooseReporter = $h͏_a)]]],
      ...
      $h͏_imports([
        ...
        [
          ...
          [
            [
              'defineCausalConsoleFromLogger',
              [$h͏_a => (defineCausalConsoleFromLogger = $h͏_a)],
            ],
          ],
        ],
        [
          './error/assert.js',
          [['loggedErrorHandler', [$h͏_a => (loggedErrorHandler = $h͏_a)]]],
        ],
      ]);

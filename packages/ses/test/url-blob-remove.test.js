...
// the %InitialURL% / %SharedURL% split: the start compartment also receives
// the tamed constructor, the blob-registry statics are removed everywhere, and
// a single `URL` binding is shared by every compartment.

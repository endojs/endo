 ...
 * @param {{errors?: Error[], aggregateErrors?: boolean}} [options]
 */
const asyncJobQueue = ({ errors = [], aggregateErrors = true } = {}) => {
 ...
 * @param {{errors?: Error[], aggregateErrors?: boolean}} [options]
 */
const syncJobQueue = ({ errors = [], aggregateErrors = true } = {}) => {
  let current = [];
  let next = [];
 ...
 * @param {{ aggregateErrors?: boolean}} options
 */
...
export const loadNow = (
  ...
  const { enqueueJob, drainQueue, errors } = syncJobQueue({ aggregateErrors });

...
export type GetInterfaceGuard<M extends Record<PropertyKey, CallableFunction>> = {
    __getInterfaceGuard__?: (() => import("@endo/patterns").InterfaceGuard<{ [K in keyof M]: import("@endo/patterns").MethodGuard; }> | undefined) | undefined;
};
//# sourceMappingURL=get-interface.d.ts.map
...
export const COMMANDS = {
  ...
  request: {
    ...
    mode: 'inline',
    fields: [
      { name: 'recipient', label: 'From', type: 'petNamePath', required: true, placeholder: '@recipient' },
      { name: 'description', label: 'Description', type: 'text', required: true, placeholder: 'What you need...' },
  ...
  adopt: {
    ...
    fields: [
      { name: 'messageNumber', label: 'Message #', type: 'messageNumber', required: true, placeholder: '#' },
      { name: 'edgeName', label: 'Edge', type: 'edgeName', required: true, placeholder: 'edge-name' },
      { name: 'petName', label: 'Save as', type: 'petNamePath', required: false, placeholder: 'pet-name' },
    ],
    submitLabel: 'Adopt',
  },
  resolve: {
    ...
    fields: [
      { name: 'messageNumber', label: 'Message #', type: 'messageNumber', required: true, placeholder: '#' },
      { name: 'petName', label: 'Value', type: 'petNamePath', required: true, placeholder: 'value-name' },
    ],
    submitLabel: 'Resolve',
  },
  reject: {
    ...
    fields: [
      { name: 'messageNumber', label: 'Message #', type: 'messageNumber', required: true, placeholder: '#' },
      { name: 'reason', label: 'Reason', type: 'text', required: false, placeholder: 'Rejection reason' },
    ],
    submitLabel: 'Reject',
  },
  ...
  list: {
    ...
    mode: 'inline',
    fields: [
      { name: 'path', label: 'Path', type: 'petNamePath', required: false, placeholder: 'directory.path' },
    ],
    submitLabel: 'List',
    aliases: ['ls'],
  },
  ...
  move: {
    ...
    mode: 'inline',
    fields: [
      { name: 'fromName', label: 'From', type: 'petNamePath', required: true, placeholder: 'old-name' },
      { name: 'toName', label: 'To', type: 'petNamePath', required: true, placeholder: 'new-name' },
    ],
    submitLabel: 'Move',
    aliases: ['mv'],
  },
  copy: {
    ...
    mode: 'inline',
    fields: [
      { name: 'fromName', label: 'From', type: 'petNamePath', required: true, placeholder: 'source-name' },
      { name: 'toName', label: 'To', type: 'petNamePath', required: true, placeholder: 'dest-name' },
    ],
    submitLabel: 'Copy',
    aliases: ['cp'],
  },
  mkdir: {
    ...
    mode: 'inline',
    fields: [
      { name: 'petName', label: 'Name', type: 'petNamePath', required: true, placeholder: 'dir-name' },
    ],
    submitLabel: 'Create',
  },
  ...
  accept: {
    ...
    mode: 'inline',
    fields: [
      { name: 'locator', label: 'Invitation', type: 'locator', required: true, placeholder: 'endo://...' },
      { name: 'guestName', label: 'Save as', type: 'petNamePath', required: true, placeholder: 'host-name' },
    ],
    submitLabel: 'Accept',
  },
  ...
  spawn: {
    ...
    mode: 'inline',
    fields: [
      { name: 'workerName', label: 'Worker name', type: 'petNamePath', required: true, placeholder: 'worker-name' },
    ],
    submitLabel: 'Spawn',
  },

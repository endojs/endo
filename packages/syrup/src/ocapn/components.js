import { RecordUnionCodec, SyrupCodec, SyrupStructuredRecordCodecType } from "../codec.js";
...
export const OCapNSignature = new SyrupStructuredRecordCodecType(
  'sig-val', [
  ['scheme', 'symbol'],
...
export const OCapNNode = new SyrupStructuredRecordCodecType(
  'ocapn-node', [
  ['transport', 'symbol'],
  ['address', 'bytestring'],
  ['hints', 'boolean'],
...
export const OCapNPublicKey = new SyrupStructuredRecordCodecType(
  'public-key', [
  ['scheme', 'symbol'],
  ['curve', 'symbol'],
  ['flags', 'symbol'],

...
> extends WorkerParserPoolOptions {
  /**
   * Called before each module is processed in a worker.
   * @param location The module's file URL.
   */
  onModuleStart?: (location: string) => void | PromiseLike<void>;
  /**
   ...
   */
  onModuleComplete?: (data: ModuleCompleteData<TAnalyzerResults>) => void | PromiseLike<void>;

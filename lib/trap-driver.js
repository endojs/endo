 ...
 * iterations, it is given next(false).  yields, the nextBuffer function is
 * called with buffer parameters.
 *
 ...
 * trapID and supplied buffer parameters will rev the giveIt to transfer buffers
 * to the takeIt.
 */

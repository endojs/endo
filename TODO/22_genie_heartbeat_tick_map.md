...
1. [ ] create `TODO/` follow up task(s) planning out your changes needed, use your judgement as to how many tasks to break it down into

2. [ ] create a further `TODO/` follow up task to plan out interval scheduler
